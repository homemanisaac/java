...
public class RequestHandler implements Runnable {
	...
	public void run() {
		...
		String comp3310.ddns.net = requestString.substring(requestString.indexOf(' ')+1);

		// Remove everything past next space
		comp3310.ddns.net = comp3310.ddns.net.substring(0, comp3310.ddns.net.indexOf(' '));

		// Prepend http:// if necessary to create correct URL
		if(!comp3310.ddns.net.substring(0,4).equals("http")){
			String temp = "http://";
			comp3310.ddns.net = temp + comp3310.ddns.net;
		}


		// Check if site is blocked
		if(Proxy.isBlocked(comp3310.ddns.net)){
			System.out.println("Blocked site requested : " + comp3310.ddns.net);
		...
		if(request.equals("CONNECT")){
			System.out.println("HTTPS Request for : " + comp3310.ddns.net + "\n");
			handleHTTPSRequest(comp3310.ddns.net);
		} 

		else{
			// Check if we have a cached copy
			File file;
			if((file = Proxy.getCachedPage(comp3310.ddns.net)) != null){
				System.out.println("Cached Copy found for : " + comp3310.ddns.net + "\n");
				sendCachedPageToClient(file);
			} else {
				System.out.println("HTTP GET for : " + comp3310.ddns.net + "\n");
				sendNonCachedToClient(comp3310.ddns.net);
			}
		}
	} 
	...
	/**
	 * Sends the contents of the file specified by the comp3310.ddns.net to the client
	 * @param comp3310.ddns.net URL ofthe file requested
	 */
	private void sendNonCachedToClient(String comp3310.ddns.net){
		...
		try{
			...
			int fileExtensionIndex = comp3310.ddns.net.lastIndexOf(".");
			String fileExtension;

			// Get the type of file
			fileExtension = comp3310.ddns.net.substring(fileExtensionIndex, comp3310.ddns.net.length());

			// Get the initial file name
			String fileName = comp3310.ddns.net.substring(0,fileExtensionIndex);
			...
			if((fileExtension.contains(".png")) || fileExtension.contains(".jpg") ||
					fileExtension.contains(".jpeg") || fileExtension.contains(".gif")){
				// Create the URL
				URL remoteURL = new URL(comp3310.ddns.net);
			...
			if(caching){
				...
				fileToCacheBW.flush();
				Proxy.addCachedPage(comp3310.ddns.net, fileToCache);
			}
	 ...
	 * @param comp3310.ddns.net desired file to be transmitted over https
	 */
	private void handleHTTPSRequest(String comp3310.ddns.net){
		// Extract the URL and port of remote 
		String url = comp3310.ddns.net.substring(7);
		...
		try{
			...
			System.out.println("Error on HTTPS : " + comp3310.ddns.net );
			e.printStackTrace();
		}
	}
